...
1. **레이어 선택**: 화면 상단의 레이어 탭에서 편집할 레이를 선택합니다.
2. **키 선택**: 키 그리드에서 원하는 키를 클릭합니다.
![키 그리드 이미지](./images/4.jpg "키 그리드 이미지입니다")
3. **키 설정**: 키 설정 창에서 다음과 같은 옵션을 선택할 수 있습니다:
   ...
   - **문장 매크로**: 여러 키 입력을 문자열로 작성하여 매핑합니다. 예: "hello world".   어를 선택합니다.
![키 설정 메뉴](./images/2.jpg "키 설정 메뉴 이미지입니다")

![설정 키 리스트 이미지](./images/3.jpg "설정 키 리스트 이미지입니다")
